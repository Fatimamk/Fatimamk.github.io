...
module.exports = class extends Page {
    constructor(){
        super({title:"Home", sName:"Fatima K"});
    }
    render(sPage) {
        const oJson = fetch ("https://mobile-final-ux308-default-rtdb.firebaseio.com/kits.json").json();
        console.log(oJson);
        let sResult = "<h1>Ramadan Ready Kits</h1>";
